export default function SelectInput({ country, handleChange, index, label }) {
  ...
  return (
    <div style={{ display: "flex", gap: "0.5rem", position: "relative" }}>
      ...
      >
        ...
        <option value={"EUR"}>an Union</option>
        ...
        <option value={"THB"}>hailand</option>
        ...
        <option value={"XPF"}>ollectivités d'Outre-Mer</option>
